                    ...
                    <div class="container d-flex flex-column align-items-center gap-3 text-light text-center p2" style="max-height: 450px; overflow-y: auto;">
                        <div class="row bg-warning rounded-3" style="width: 95%;">
                            <div class="col">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                    class="bi bi-stopwatch my-2" viewBox="0 0 16 16">
                            ...
                            <div class="col">
                                <p class="mb-0 mt-2 fw-bold fs-5">Camping</p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                    class="bi bi-person my-2" viewBox="0 0 16 16">
                                    <path
                                        d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z" />
                                </svg>
                                <p>3 Mature 2 Child</p>
                            </div>
                            <div class="col">
                                <p class="mb-0 mt-2">20 July 2023</p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                    class="bi bi-coin my-2" viewBox="0 0 16 16">
                                    <path
                        ...
                        <div class="row bg-success rounded-3" style="width: 95%;">
                            <div class="col">
                                <p class="mb-0 mt-2">Up coming</p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                    class="bi bi-stopwatch my-2" viewBox="0 0 16 16">
                            ...
                            <div class="mb-3 text-success-emphasis d-flex justify-content-end">
