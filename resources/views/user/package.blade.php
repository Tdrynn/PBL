...
@section('content')
    ...
    <div class="row">
        <section id="package" class="Package d-flex flex-column align-items-center text-light justify-content-center py-5">
            ...
            <div class="d-flex flex-column align-items-center gap-4 my-auto">
                <div class="card rounded-top-4 p-4 d-flex flex-row align-items-center"
                    ...
                    <div>
                        ...
                        <a href="{{ route('picnic') }}">
                            <button class="btn mt-3 w-25 text-light" style="background-color: #114A06; height: 45px;">Learn
                                More</button>
                        </a>
                    </div>
                </div>
